...
/**
 * Created by Milan on 2016-02-12.
 */
public class VideoAudit extends RealmObject {
    ...
    {
        RealmResults<VideoAudit> lstVideoAudit = realmDb.where(VideoAudit.class).findAll();
        return lstVideoAudit.size() > 0 ? lstVideoAudit.max("objectId").intValue() + 1 : 1;
    }
