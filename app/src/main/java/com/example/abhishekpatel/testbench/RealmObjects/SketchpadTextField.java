 ...
 */
public class SketchpadTextField extends RealmObject{
    ...
    {
        RealmResults<SketchpadTextField> sketchpadTextFields = realmDb.where(SketchpadTextField.class).findAll();
        return sketchpadTextFields.size() > 0 ? sketchpadTextFields.max("objectId").intValue() + 1 : 1;
    }
